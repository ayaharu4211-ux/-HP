        ...
        <div className="max-w-6xl mx-auto flex flex-col items-center">
          ...
          <div className="flex justify-center pt-8 md:pt-16">
            <button 
              ...
              className="px-8 md:px-12 py-3 md:py-5 bg-slate-900 text-white rounded-full text-[9px] md:text-xs font-bold tracking-[0.2em] md:tracking-[0.4em] uppercase hover:bg-slate-800 transition-all flex items-center gap-3 md:gap-4 group/btn shadow-2xl"
            >
